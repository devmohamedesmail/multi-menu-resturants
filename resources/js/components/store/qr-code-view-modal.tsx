...
export default function QRCodeViewModal({ table, store, onClose }: QRCodeViewModalProps) {
    ...
    return (
        <dialog id="qr_view_modal" className="modal modal-open">
            <div className="modal-box max-w-2xl">
                <button 
                    onClick={onClose}
                    className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 bg-main hover:bg-second text-white"
                >
                    <X className="w-4 h-4" />
                </button>
                ...
                <div className="text-center">
                    ...
                    {table.qr_code ? (
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-lg text-gray-600 mb-6">{t('store.scan-to-order')}</p>
